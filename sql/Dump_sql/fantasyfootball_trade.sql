...
CREATE TABLE `trade` (
  ...
  CONSTRAINT `trade_ibfk_1` FOREIGN KEY (`proposalID`) REFERENCES `proposal` (`proposalid`)
...
INSERT INTO `trade` VALUES (1,'2018-11-22',1);
...
-- Dump completed on 2018-11-20 15:09:03
